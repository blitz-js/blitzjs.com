...
:::info Unlike Next.js, your `api/` folder should be a sibling of `pages/`
...
You can use the `getSessionContext` function to get the session of the
user. Here is an example using session in a API route
`app/api/customRoute.tsx`:
