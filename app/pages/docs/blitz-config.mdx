...
`blitz.config.ts`. The `component`, `inputType`, `zodType`, and
...
If you want to know more about the `blitz generate` command, you can check
out the [docs](/docs/cli-generate).
