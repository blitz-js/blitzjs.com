---
title: Blitz.js with an Existing Next.js Project
sidebar_label: Blitz.js with Next.js
---
...
```sh
yarn add blitz@alpha @blitzjs/next

# or

pnpm add blitz@alpha @blitzjs/next

#or

npm i blitz@alpha @blitzjs/next
```
