...
This will run a script provided with the optional `file` flag. If omitted, it defaults to `db/seeds`. 
This is often used to quickly set up the development environment. For examples check
