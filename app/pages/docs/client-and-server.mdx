...
#### Framework Adapters
Blitz offers adapters for frameworks that allow you to inject plugins like the RPC or auth plugin.
For more information regarding specific adapters head to the associated section in the documenation.
