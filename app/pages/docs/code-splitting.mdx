...
Blitz automatically optimizes your JavaScript bundles for each page, so your users will only download the required assets for a given route (without any extra effort on your part!). This technique is known as [code splitting](https://reactjs.org/docs/code-splitting.html).
