...
#### Flightcontrol makes it extremely easy to deploy anything directly to AWS. But rest assured, it handles ALL the AWS setup and management for you.

The benefit of this approach vs something like Heroku is that you now have
full ownership over everything. So should the need arise, you can easily
pop the hood to inspect and tweak anything.
