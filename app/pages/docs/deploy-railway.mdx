...
1. Sign up for an account on [Railway](https://railway.app) - they have a
...
2. Create a new project (via your
   [Dashboard](https://railway.app/dashboard) if not prompted)
...
3. If a database is required, select **Provision PostgreSQL** (or
