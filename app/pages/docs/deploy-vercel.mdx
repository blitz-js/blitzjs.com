...
for your database. And therefore it's too easy to accidentally deploy your
app to a different region than your database.
...
postgres. Both Digital Ocean and Heroku allow you to easily add pgbouncer.
