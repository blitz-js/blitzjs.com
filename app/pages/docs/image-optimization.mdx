...
[`imageSizes`](#device-sizes) to reduce the total number of possible
generated images.
...
> **Attention**: This property is only meant for advanced usage. Switching
> an image to load with `eager` will normally **hurt performance**.
>
