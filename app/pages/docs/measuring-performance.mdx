...
Blitz has a built-in relayer that allows you to analyze and measure the performance of
pages using different metrics.

To measure any of the supported metrics, you need export a `reportWebVitals` function from the [`App` component](./app-component):
