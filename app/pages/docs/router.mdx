...
In some cases (for example, if using a [Custom Server](./custom-server)), you may
wish to listen to
...
that case. See [Disabling file-system routing](./custom-server#disabling-file-system-routing).
