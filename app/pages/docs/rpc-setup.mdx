...
3. Add the following to your `blitz-server.ts` file:
...
4. Add Blitz RPC API Route:

4.1 App router (recommended):

Create an `app/api/rpc/[[...blitz]]` directory in your `src` directory with
a `route.ts` file, and add the following lines:
