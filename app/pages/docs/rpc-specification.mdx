...
**For using queries and mutations in your app, refer to [Using Queries](./query-usage) and [Using Mutations](./mutation-usage).**

**If you want to access your app e.g. as an external API, take a look at [API Routes](./api-routes) instead.**
:::
