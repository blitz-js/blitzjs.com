...
the default values by just pressing **Enter** when asked (you'll create a
Full Blitz app with TypeScript, Yarn and React Final From).
...
In order for `blitz console`, `yarn tsc` or `git push` to succeed, you'll
need to delete `app/choices/mutations/createChoice.ts` (unused) or update
