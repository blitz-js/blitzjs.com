---
title: Upgarding Your Blitz App to Blitz 2.0
...
2. Install `@blitzjs/next`, `@blitzjs/rpc`, and `@blitzjs/auth`.
3. Set `blitz` version to `alhpa`.
...
`pages/api/rpc/[[blitz]].ts` file with the followinf content:
