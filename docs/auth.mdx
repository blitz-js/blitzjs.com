...
Blitz session management is based on the state of the art [SuperTokens library](https://supertokens.io/). [Rishabh Poddar](https://twitter.com/rishpoddar), the CTO of SuperTokens, designed and oversaw our implementation. We're extremely grateful for his help! 🙏
