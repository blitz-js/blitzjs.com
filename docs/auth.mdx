...
Public anonymous session data is stored in a JWT and not stored in the database. Anonymous sessions will only be saved in your database if you call `session.setPrivateData()`.
