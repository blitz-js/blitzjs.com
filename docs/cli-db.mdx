...
This will completely destroy your database and create a new one with fresh migrations. This is useful in development if you someone mess up your db or simply want to clean out test data.
