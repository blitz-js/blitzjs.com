...
Currently to test the local dev version of Blitz, you have to test apps inside the `examples/` folder in the repo. In there, the blitz dependency will automatically use the local dev version.
