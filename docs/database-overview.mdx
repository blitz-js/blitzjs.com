...
2. Then run `blitz prisma migrate dev --preview-feature` in your terminal to apply the changes
...
3. Run `blitz prisma migrate dev --preview-feature`. This command will create the database (if it does not already exist) and tables based on your schema.
...
4. Run `blitz prisma migrate dev --preview-feature` to get your new database to the latest version of your migrations
