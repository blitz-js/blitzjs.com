...
By default, Blitz has a `db/seed.ts`, where you can add dummy data to quickly seed your environment.
...
> TIP: Use a library like [chance](https://chancejs.com/) or [faker.js](https://github.com/Marak/Faker.js) to have more realistic data (names, addresses, emails, places, dates, event lorem ipsusm)
