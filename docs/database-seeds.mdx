...
By default, Blitz has a `db/seeds.ts`, where you can add dummy data to quickly seed your environment.
...
2. Now simply run `blitz db seed` and you're done. You should be all set with fresh new data in your database.

> TIP: Use a library like [chance](https://chancejs.com/) or [faker.js](https://github.com/Marak/Faker.js) to have more realistic data (names, addresses, emails, places, dates, even lorem ipsusm)
