...
6. Add `next` as a devDependency at the same version that Blitz includes (this is a temporary workaround until Blitz has first class support (very soon!))
7. Run `git push` if using the [Git Integration](https://vercel.com/docs/v2/git-integrations) or `vercel` if using Vercel CLI
