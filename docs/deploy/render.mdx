...
And you need to add this model to `db/schema.prisma` because Postgres on Render has PostGIS installed by default. You need this model in your schema, but otherwise you can totally ignore it.
