...
`fallback: true` will not _update_ generated pages, for that take a look at [Incremental Static Regeneration](/docs/get-static-props#incremental-static-regeneration).
...
`fallback: 'blocking'` will not _update_ generated pages by default. To update generated pages, use [Incremental Static Regeneration](/docs/get-static-props#incremental-static-regeneration) in conjunction with `fallback: 'blocking'`.
