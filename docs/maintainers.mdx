...
Please DM a core team member (Brandon Bayer) in Slack if you're interested in becoming an official maintainer!
...
- All `#lang-*` channels are for Japanese speakers (In yours country speaker channel, monitoring as possible.)
