...
sidebar_label: Write Mutation Resolvers
---
...
- `app/modules/projects/mutations/createProject.ts`
- `app/modules/admin/projects/mutations/createProject.ts`
...
```ts
// app/modules/products/mutations/createProduct.tsx
