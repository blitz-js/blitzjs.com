...
In Blitz, a **page** is a [React Component](https://reactjs.org/docs/components-and-props.html) exported from a `.js`, `.jsx`, `.ts`, or `.tsx` file in a `pages` directory. Each page is associated with a route based on its file name.

All of the following are valid pages:

- `app/pages/about.tsx`
- `app/modules/projects/pages/projects/index.tsx`
- `app/modules/tasks/pages/projects/[projectId]/tasks/[taskId].tsx`
...
> To learn more about routing, check the [Routing documentation](./routing).
...
1. `getStaticProps` - To load the **data** for your page. See the [`getStaticProps` documentation](./get-static-props) for more details.
2. `getStaticPaths` - To load the possible **paths** for your page. See the [`getStaticPaths` documentation](./get-static-paths) for more details.
...
See the [`getServerSideProps` documentation](./get-server-side-props) for more details.
