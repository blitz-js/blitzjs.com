...
```tsx
// File: app/modules/products/pages/products/[id].tsx
// URL: /products/2
import {useParams} from "blitz"
...
This hook return a single parameters for the current route. The default return type is `undefined | string | string[]`, but you can optionally provide a type argument to cast the return type.
...
```tsx
// File: app/modules/locations/pages/locations/[id]/[[...zipcode]].tsx
