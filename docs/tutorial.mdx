...
> Note: Your new blitz app is shipped with user authentication and authorization. Surprise! :-)
...
CREATE    app/modules/questions/pages/questions/index.tsx
CREATE    app/modules/questions/pages/questions/new.tsx
CREATE    app/modules/questions/pages/questions/[questionId]/edit.tsx
CREATE    app/modules/questions/pages/questions/[questionId].tsx
CREATE    app/modules/questions/components/QuestionForm.tsx
CREATE    app/modules/questions/queries/getQuestions.ts
CREATE    app/modules/questions/queries/getQuestion.ts
CREATE    app/modules/questions/mutations/createQuestion.ts
CREATE    app/modules/questions/mutations/deleteQuestion.ts
CREATE    app/modules/questions/mutations/updateQuestion.ts
```
...
CREATE    app/modules/choices/queries/getChoices.ts
CREATE    app/modules/choices/queries/getChoice.ts
CREATE    app/modules/choices/mutations/createChoice.ts
CREATE    app/modules/choices/mutations/deleteChoice.ts
CREATE    app/modules/choices/mutations/updateChoice.ts
```
...
Prisma does not yet support "cascading deletes". In the context of this tutorial, that means it does not currently delete the `Choice` data when deleting a `Question`. We need to temporarily augment the generated `deleteQuestion` mutation in order to do this manually. Open up `app/modules/questions/mutations/deleteQuestion.ts` in your text editor and add the following to the top of the function body:
...
```jsx
// app/modules/questions/mutations/deleteQuestion.ts
...
Jump over to `app/modules/questions/pages/questions/index.tsx`. Notice that a `QuestionsList` component has been generated for you:
...
Next, let’s apply a similar fix to `app/modules/questions/pages/questions/new.tsx`. In the form submission, replace
...
Finally, we need to fix the edit page. Open `app/modules/questions/pages/questions/[questionId]/edit.tsx` and replace
...
You’re doing great so far! The next thing we’ll do is give our form some real inputs. At the moment it’s giving every `Question` the same name! Have a look at `app/modules/questions/components/QuestionForm.tsx` in your editor.
...
Finally, we’re going to make sure all that data is submitted. Open up `app/modules/questions/pages/questions/new.tsx` in your editor and replace
...
import createQuestion from "app/modules/questions/mutations/createQuestion"
import QuestionForm from "app/modules/questions/components/QuestionForm"
...
```js
// app/modules/questions/queries/getQuestion.ts
...
```js
// app/modules/questions/queries/getQuestions.ts
...
Open `app/modules/questions/pages/questions/[questionId].tsx` in your editor. First, we’re going to improve this page somewhat.
...
```jsx
import updateChoice from "app/modules/choices/mutations/updateChoice"
...
import getQuestion from "app/modules/questions/queries/getQuestion"
import deleteQuestion from "app/modules/questions/mutations/deleteQuestion"
import updateChoice from "app/modules/choices/mutations/updateChoice" // highlight-line
