---
title: usePaginatedQuery API
sidebar_label: usePaginatedQuery API
---

See the [Using Queries Guide](http://localhost:3000/docs/query-usage#pagination) for example usage.
