...
- `blitz install emotion` - one command to install and configure styled-components
- `blitz install chakra` - one command to install and configure Sentry error logging
