...
If you're going to be writing tests for your recipe you'll need a build and test setup. We recommend [`tsdx`](https://github.com/jaredpalmer/tsdx) and Jest for building and running tests.
...
We use a custom templating language that's natural to both read and write. [Read our template documentation to learn how to write templates](templates).
