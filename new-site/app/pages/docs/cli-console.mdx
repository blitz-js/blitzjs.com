...
Starts a Node.js REPL with your [database](./database-overview.mdx) and all your [queries](./query-resolvers.mdx) and [mutations](./mutation-resolvers.mdx) preloaded.
