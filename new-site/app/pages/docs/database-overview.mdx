...
1. [Install and run Postgres locally](./postgres.mdx).
...
4. Run `blitz prisma migrate dev --preview-feature`. This command will create the database (if it does not already exist) and tables based on your schema.
