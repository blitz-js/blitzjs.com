...
In `getServerSideProps`, pass a query function to [`invokeWithMiddleware`](./invoke#invokewithmiddleware) which will ensure appropriate middleware is run before/after your query function.
