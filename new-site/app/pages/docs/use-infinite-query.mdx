...
function Projects(props) {
  ...
  ] = useInfiniteQuery(getProjectsInfinite, (page = { take: 3, skip: 0 }) => page, {
...
The options are identical to the options for the [useQuery hook](./use-query.mdx) with the addition of the following:
