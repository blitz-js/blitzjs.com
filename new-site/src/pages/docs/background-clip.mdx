...
<template preview>
  <div class="flex justify-around">
    <div class="flex-1">
      ...
      <div
        class="mx-auto bg-purple-500 w-24 h-24 bg-clip-border border-4 border-dashed border-purple-800 p-4"
      ></div>
    </div>
    <div class="flex-1">
      <p class="text-center text-sm text-gray-600 mb-1">.bg-clip-padding</p>
      <div
        class="mx-auto bg-purple-500 w-24 h-24 bg-clip-padding border-4 border-dashed border-purple-800 p-4"
      ></div>
    </div>
    <div class="flex-1">
      <p class="text-center text-sm text-gray-600 mb-1">.bg-clip-content</p>
      <div
        class="mx-auto bg-purple-500 w-24 h-24 bg-clip-content border-4 border-dashed border-purple-800 p-4"
      ></div>
    </div>
  </div>
</template>
