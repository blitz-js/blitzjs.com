...
Because Tailwind doesn't impose any opinions about _how_ you build the components in your UI, you can implement them however you like according to your own browser support policy.
