...
It's important to understand that this prefix is added to the beginning of each _utility_ name, not to the entire class name.

That means that classes with responsive or state prefixes like `sm:` or `hover:` will still have the responsive or state prefix _first_, with your custom prefix appearing after the colon:
