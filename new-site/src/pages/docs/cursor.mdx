...
<template preview class="text-center p-4">
  <div class="cursor-auto max-w-xs p-2 bg-gray-200 mx-auto">Hover over this text</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-default max-w-xs p-2 bg-gray-200 mx-auto">Hover over this text</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-pointer max-w-xs p-2 bg-gray-200 mx-auto">Hover me</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-wait max-w-xs p-2 bg-gray-200 mx-auto">Hover me</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-text max-w-xs p-2 bg-gray-200 mx-auto">Hover me</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-move max-w-xs p-2 bg-gray-200 mx-auto">Hover me</div>
</template>
...
```html
<template preview class="text-center p-4">
  <div class="cursor-not-allowed max-w-xs p-2 bg-gray-200 mx-auto">Hover me</div>
</template>
