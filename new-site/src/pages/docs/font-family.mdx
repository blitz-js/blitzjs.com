...
```html
<template preview>
  <p class="font-system text-lg text-gray-800 text-center">I'm a sans-serif paragraph.</p>
</template>

<p class="font-sans text-lg text-gray-800 text-center">I'm a sans-serif paragraph.</p>
```
...
```html
<template preview>
  <p class="font-serif text-lg text-gray-800 text-center">I'm a serif paragraph.</p>
</template>
```
...
```html
<template preview>
  <p class="font-mono text-lg text-gray-800 text-center">I'm a monospaced paragraph.</p>
</template>
```
