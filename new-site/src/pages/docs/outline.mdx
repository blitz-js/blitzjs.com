...
<template preview class="flex space-x-6 justify-center bg-white p-4">
  ...
  <input
    type="text"
    class="px-3 py-2 border rounded focus:outline-none focus:shadow-outline focus:border-blue-400"
...
<template preview class="flex">
  <div class="min-w-0 flex-1 bg-white p-6 flex items-center justify-center">
    <button
      type="button"
      class="px-4 py-2 rounded font-medium bg-blue-600 text-white focus:outline-black"
    >
      Button A
    </button>
  </div>
  <div class="min-w-0 flex-1 bg-blue-700 p-6 flex items-center justify-center">
    <button
      type="button"
      class="px-4 py-2 rounded font-medium bg-white text-gray-900 focus:outline-white"
    >
      Button B
    </button>
  </div>
