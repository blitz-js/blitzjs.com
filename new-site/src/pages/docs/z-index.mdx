...
<ResponsiveCodeSample
  ...
  preview={(className) => (
    <div className="relative w-full h-32 text-center">
      <div
        className={`${className} absolute w-full h-12 mt-12 bg-yellow-400 flex justify-center items-center`}
      >
        yellow
      </div>
      <div className="z-40 absolute w-24 h-24 ml-4 mt-0 bg-gray-400 flex justify-center items-center">
        z-40
      </div>
      <div className="z-30 absolute w-24 h-24 ml-6 mt-2 bg-gray-500 flex justify-center items-center">
        z-30
      </div>
      <div className="z-20 absolute w-24 h-24 ml-8 mt-4 bg-gray-600 flex justify-center items-center">
        z-20
      </div>
      <div className="z-10 absolute w-24 h-24 ml-10 mt-6 bg-gray-700 flex justify-center items-center">
        z-10
      </div>
      <div className="z-0 absolute w-24 h-24 ml-12 mt-8 bg-gray-800 flex justify-center items-center">
        z-0
      </div>
    </div>
  )}
