      ...
      <main className="container">
        ...
        <div className="padding-vert--xl">
          <div className="">
            ...
            <p>
              Blitz brings back the <b>simplicity and conventions</b> of server-rendered frameworks
              like Ruby on Rails while preserving everything we love about React and client-side
              rendering!
            </p>
            <p>
              Blitz is the framework for the 99% of us at companies with {`<`}
              100 employees. This means{" "}
              <b>we don't force you to use advanced technologies like GraphQL</b> . We let you add
              advanced technologies on your terms and at your pace.
            </p>
            <p>
              Blitz <b>maximizes your productivity</b> both when starting an app and when scaling it
              to lots of code and users.
            </p>
          </div>
        </div>
            ...
            {features.map((feature) => {
              return (
                <div className="col col--6 padding-vert--sm">
                  <span role="img" aria-label="lightning" className="margin-right--sm">
                    ⚡️
                  </span>{" "}
                  {feature}
                </div>
